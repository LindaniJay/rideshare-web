  ...
  const whyHost = [
    {
      ...
      description: "Make your car work for you when you're not using it. Hosts typically earn R2,500–R7,500 per month.",
      icon: <DollarSign size={32} />,
      stat: 'R2,500–R7,500/mo',
    },
    {
  ...
  const faqs = [
    {
      ...
      answer: 'Earnings vary by car type, location, and availability. Most hosts earn R2,500–R7,500 per month. Full-time hosts with premium vehicles can earn R8,000+ monthly.',
    },
    {
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Become a host on RideShare SA and earn extra income by renting out your car." />
      ...
      <div>
        ...
        <section className="relative overflow-hidden bg-gradient-to-br from-accent-500 to-accent-600 text-white py-20">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h1 className="text-4xl md:text-5xl font-bold font-heading mb-6">For Hosts</h1>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 glass-card p-8">
                <h2 className="text-2xl md:text-3xl font-bold font-heading text-gray-900 mb-3">Protection at a glance</h2>
                <p className="text-gray-600 mb-6">A quick overview of how hosting is designed to stay safe and fair.</p>
                <ul className="space-y-3 text-gray-700">
                  <li className="flex items-start gap-3"><span className="text-green-600 mt-1">&#8226;</span>Insurance coverage included during rentals</li>
                  <li className="flex items-start gap-3"><span className="text-green-600 mt-1">&#8226;</span>Renter verification (ID + driver's licence checks)</li>
                  <li className="flex items-start gap-3"><span className="text-green-600 mt-1">&#8226;</span>Clear claim steps + support if something goes wrong</li>
                  <li className="flex items-start gap-3"><span className="text-green-600 mt-1">&#8226;</span>Clear coverage rules and claim steps</li>
                </ul>
              </div>
              <div className="glass-card p-8">
                <div className="text-sm font-semibold text-accent-700 mb-2">Want the full details?</div>
                <div className="text-gray-600 leading-relaxed mb-6">See verification steps and safety processes.</div>
                <Link to="/safety" className="btn-outline w-full inline-flex items-center justify-center">View safety & trust</Link>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="section-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 mb-4">Why List Your Car on RideShare SA?</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">The smart way to make your car work for you</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {whyHost.map((item, index) => (
                <div key={index} className="text-center">
                  <div className="text-accent-500 mb-6 flex justify-center">{item.icon}</div>
        ...
        <section className="section-light py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 mb-4">Potential Earnings by Car Type</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">See what you could earn with different vehicles</p>
            </div>
                ...
                <div key={index} className="glass-card p-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-lg font-semibold font-heading text-gray-900 mb-2">{example.car}</h3>
        ...
        <section className="section-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 mb-4">Safety & Protection</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">Your peace of mind is our priority</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {safetyFeatures.map((feature, index) => (
                <div key={index} className="glass-card p-6 text-center">
                  ...
                  <h3 className="text-lg font-semibold font-heading text-gray-900 mb-3">{feature.title}</h3>
