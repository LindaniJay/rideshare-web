...
export default function Contact() {
  ...
  const subjectLabel = (value: string) => {
    switch (value) {
      ...
      case 'payment': return 'Payment Question';
  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Contact RideShare SA for support, partnership, or general inquiries." />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Contact RideShare SA for support, partnership, or general inquiries."
          })}
        </script>
      </Helmet>
      ...
      <div>
        ...
        <section className="section-white py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 mb-4">Get in Touch</h2>
              <p className="text-xl text-gray-600 max-w-2xl mx-auto">Multiple ways to reach our support team</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              {contactInfo.map((info, index) => (
                <div key={index} className="glass-card p-8 text-center">
                  ...
                  <h3 className="text-xl font-semibold font-heading text-gray-900 mb-2">{info.title}</h3>
        ...
        <section className="section-light py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 mb-4">Send Us a Message</h2>
        ...
        <section className="section-white py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold font-heading text-gray-900 mb-4">Business & Partnership Inquiries</h2>
              <p className="text-xl text-gray-600">Interested in partnering with RideShare SA?</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {[
                { title: 'Corporate Accounts', desc: 'For companies that need regular vehicle access, email us to discuss options and availability.', subject: 'Corporate Accounts' },
                { title: 'Fleet Partnerships', desc: 'Own multiple vehicles? Join our fleet partner program and maximize your earning potential with dedicated support.', subject: 'Fleet Partnership' },
                { title: 'Media & Press', desc: 'For media inquiries, press releases, and interview requests, please contact our communications team.', subject: 'Media Inquiry' },
                { title: 'Investor Relations', desc: "Interested in learning more about RideShare SA? Send us an email and we'll respond with the right info.", subject: 'Investor Relations' },
              ].map((card, i) => (
                <div key={i} className="glass-card p-6">
                  <h3 className="text-xl font-semibold font-heading text-gray-900 mb-3">{card.title}</h3>
                  <p className="text-gray-600 mb-4">{card.desc}</p>
                  <a href={`mailto:${SUPPORT_EMAIL}?subject=${encodeURIComponent(`RideShare SA — ${card.subject}`)}`}
